    ...
    <nav class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header page-scroll">
                ...
                <a href="#" class="navbar-brand"><i class="fa fa-lg fa-grav"></i> Gynaptic</a>
                ...
                <ul class="nav navbar-nav navbar-right">
									<li class="dropdown">
										...
										<ul class="dropdown-menu" role="menu">
											<li><a href="examples/xor">Learn XOR</a></li>
										</ul>
									</li>
                    <li>
                        <a href="https://github.com/wagenaartje/gynaptic/wiki" target="_blank">Documentation</a>
                    </li>
										<li>
											<a class="navbar-brand" href="https://github.com/wagenaartje/gynaptic" target="_blank"><i class="fa fa-lg fa-github"></i> Github</a>
										</li>
                </ul>
            </div>
        </div>
		...
		<!-- Page Header -->
		<header class="intro-header" style="background-color: #C83B44">
		</header>
		<div class="container main">
			<div class="row" style="margin-top: 0">
				<center><p class="title">"an architecture-free<b class="transparent-text"><span class="color-text">neural network</span></b>library with<b class="transparent-text"><span class="color-text">genetic algorithm</span></b>implementations"</p></center>
				    ...
				    <div class="col-md-6">
				      <div class="media">
				        <div class="media-left">
				          <a href="">
				            <div class="fa fa-stack fa-3x">
				              <i class="fa fa-circle fa-stack-2x" style="color: #C83B44"></i>
				              <i class="fa fa-sort-numeric-desc fa-stack-1x fa-inverse"></i>
				            </div>
				          </a>
				        </div>
				        <div class="media-body">
				          <h4 class="media-heading">Selection</h4>
				          <p class="tiny">Selection is a vital part of genetic algorithms, it decides which parents should create offspring for the next generation. This library contains various selection methods that are customisable.</p>
				          <a href="https://github.com/wagenaartje/gynaptic/wiki/Selection" target="_blank" class="btn btn-default p">Learn More</a>
				        </div>
				      </div>
				    </div>
				    <div class="col-md-6">
				      <div class="media">
				        <div class="media-left">
				          <a href="">
				            <div class="fa fa-stack fa-3x">
				              <i class="fa fa-circle fa-stack-2x" style="color: #FF6245"></i>
				              <i class="fa fa-cut fa-stack-1x fa-inverse"></i>
				            </div>
				          </a>
				        </div>
				        <div class="media-body">
				          <h4 class="media-heading">Mutation</h4>
				         	<p class="tiny">Mutation is the progressive part of a genetical algorithm; it randomly modifies some offspring, possibly creating a creature that performs much better than its ancestors.</p>
				          <a href="https://github.com/wagenaartje/gynaptic/wiki/Mutation" target="_blank" class="btn btn-default">Learn More</a>
				        </div>
				      </div>
				    </div>
				    </div>
				    ...
				    <div class="col-md-6">
				      <div class="media">
				        <div class="media-left">
				          <a href="">
				            <div class="fa fa-stack fa-3x">
				              <i class="fa fa-circle fa-stack-2x" style="color: #FFAE45"></i>
				              <i class="fa fa-venus-mars fa-stack-1x fa-inverse"></i>
				            </div>
				          </a>
				        </div>
				        <div class="media-body">
				          <h4 class="media-heading">Crossover</h4>
				         	<p class="tiny">The library contains various crossover methods to create offspring from networks, layers and even from neurons! In the future, there will be an easy way to create  and integrate your own methods.</p>
				          <a href="https://github.com/wagenaartje/gynaptic/wiki/Breeding" target="_blank" class="btn btn-default">Learn More</a>
				        </div>
				      </div>
				    </div>
				    <div class="col-md-6">
				      <div class="media">
				        <div class="media-left">
				          <a href="">
				            <div class="fa fa-stack fa-3x">
				              <i class="fa fa-circle fa-stack-2x" style="color: #A02446"></i>
				              <i class="fa fa-angle-double-up fa-stack-1x fa-inverse"></i>
				            </div>
				          </a>
				        </div>
				        <div class="media-body">
				          <h4 class="media-heading">Evolution</h4>
				          <p class="tiny">The library has built-in functions to create genetic neural algorithms on the go. The functions are 100% customisable with options.</p>
				          <a href="https://github.com/wagenaartje/gynaptic/wiki/Evolution" target="_blank" class="btn btn-default">Learn More</a>
				        </div>
				      </div>
				    </div>
				  </div>
